...
| [model-routing-audit.md](./model-routing-audit.md) | The 2026-08-29 token-usage audit behind CLAUDE.md's Sonnet-delegation triggers (Opus share, per-clone call counts) |
