# Modoki Engine — Individual Contributor License Agreement (v1.0)

> **Provenance.** This is the **Harmony (HA-CLA-I) Individual Contributor License Agreement,
> version 1.0**, with **Outbound License option "any licence"** (the HA-CLA-I-ANY variant),
> adopted for Modoki Engine. Harmony agreements are standardized templates published for projects
> to adopt — see <https://www.harmonyagreements.org>. Governing law is set to **Japan** (§6.1).
>
> **Verified against the official HA-CLA-I v1.0 (2011-07-04).** The grant/rights sections (1, 2.1,
> 2.2, 2.3-Option-Five, 2.4-2.6, 3, 4, 5, 6) match the official wording. Adaptations to the
> fill-in/optional fields only: `[PROJECT_NAME]` → "Modoki Engine, a project of Masaki Nomura";
> `[JURISDICTION]` → Japan; optional brackets **not selected** (no `[or Your Affiliates]`, no Media
> licensing option, no non-owner `[NONOWNER_INSTRUCTIONS]` provisions); and the paper signature
> block replaced by the automated CLA-check sign-off (see "How to sign"). This file is **not legal
> advice**; because it is a standard template it does not require bespoke drafting, but you remain
> responsible for adopting it correctly.

Thank you for your interest in contributing to Modoki Engine, a project of Masaki Nomura ("We" or
"Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To
make this document effective, please agree to it via the automated CLA check on your pull request
(see "How to sign" at the end). This is a legally binding document, so please read it carefully
...
the exercise of the licensed rights infringes such patent claims; and provided that this license is
...
BY YOU TO US. TO THE EXTENT THAT ANY SUCH WARRANTIES CANNOT BE DISCLAIMED, SUCH
...
Japan excluding its conflicts of law provisions. Under
certain circumstances, the governing law in this section might be superseded by the United Nations
Convention on Contracts for the International Sale of Goods ("UN Convention") and the parties intend
to avoid the application of the UN Convention to this Agreement and, thus, exclude the application
...
Signing is handled by an automated CLA check on your pull request. When you open your first PR, the
CLA bot will comment with instructions; you sign by posting the exact confirmation phrase it gives
(recording your agreement in this repository). Your PR cannot be merged until the CLA check is
green. One signature covers all of Your present and future Contributions to the Material.

---

*This agreement is adapted from the Harmony (HA-CLA-I) Individual Contributor License Agreement,
Version 1.0, which is licensed under a [Creative Commons Attribution 3.0 Unported License](https://creativecommons.org/licenses/by/3.0/)
by the Harmony project (<https://www.harmonyagreements.org>).*
