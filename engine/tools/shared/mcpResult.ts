// The closed code set, `codeFromBody` and `isFailureBody` live in `./errorCodes.ts` — a dependency-free module the
// device-shipped agent bridge can import without pulling this result-formatting code along (#648).
import { ERROR_CODES, codeFromBody, isFailureBody, type ErrorCode } from './errorCodes.js';
export { ERROR_CODES, codeFromBody, isFailureBody, type ErrorCode };
