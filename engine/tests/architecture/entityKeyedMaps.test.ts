...
const LEDGER: ReadonlyArray<{ item: string; reason: string }> = [
  ...
  { item: 'rendering/Scene2D.tsx::Scene2DRenderer.activeIds',
    reason: 'scratch: Cleared at the top of renderFrame and consumed by the slot-disposal sweep at the end of the same pass; rendering/Scene2D.tsx:1561' },
  ...
  { item: 'rendering/flameMeshSync.ts::FlameMeshSyncState.recs',
    reason: 'revalidated: additive/segments compared to the live trait and rebuilt in place; uniforms, transform, scale and layers rewritten every pass; rendering/flameMeshSync.ts:192' },
