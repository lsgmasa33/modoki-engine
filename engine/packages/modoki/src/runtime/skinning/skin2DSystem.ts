...
import { Transform, SkinnedSprite2D, Bone2D, EntityAttributes } from '../traits/index';
import { rig2dProvider } from './rig2dProvider';
import type { ParsedRig2D } from './rig2dTypes';
function getRig2D(ref: string): ParsedRig2D | null { return rig2dProvider.get()?.getRig2D(ref) ?? null; }
import { resolveSprite } from '../core/textureRefs';
import { isGuid } from '../core/assetRefRules';
import { identity2D, compose2D, mul2D, removeScale2D, skinVertex2D, type Mat2D } from './rig2dMath';
import {
