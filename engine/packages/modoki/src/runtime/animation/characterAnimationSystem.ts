...
import { animationAssetProvider, type SpriteAnimSource } from './assetProviders';
function spriteAnimHasClip(anim: SpriteAnimSource, name: string) { return animationAssetProvider.get()?.spriteAnimHasClip(anim, name) ?? false; }
