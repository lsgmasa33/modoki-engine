 ...
 *
 *  Cached vs on-demand: `transformPropagationSystem` (its SIBLING in this folder since P5 of
 *  the module-boundaries work — it lived under `src/three/` before) maintains the per-frame `worldTransforms`
