 ...
 *
 *  The `deactivatedEntities` twin of this lives in `three/systems/transformPropagationSystem`
 *  and is what every RENDERER checks. SIM systems can't use it for three reasons: it comes from
 *  a THREE module (importing it would drag three into a 2D-only/playable bundle), it is produced
