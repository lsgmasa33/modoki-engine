/** loaders/gpuMemoryReport.ts — Phase 3 of #590 (docs/plans/ios-rendering-update-wedge.md).
 *
...
// Second device measurement (docs/plans/ios-rendering-update-wedge.md): fps and every live count
